...
<header class="w3-container w3-padding" style="background-image: url('assets/img/img1.png')" id="myHeader">
  ...
  <h1 class=" w3-animate-bottom  texto1" >LOS MEJORES VIAJES ESPACIALES</h1>
    ...
    <a href='/login' target="_parent"><button class="w3-btn w3-xlarge w3-pink  parpadeo w3-round-large w3-hover-light-grey"  style="font-weight:900;">INGRESAR</button></a>
    <a href='/register' target="_parent"><button class="w3-btn w3-xlarge  w3-food-spearmint parpadeo w3-round-large w3-hover-light-grey"  style="font-weight:900;">REGISTRARSE</button></a>
    </div>
  </div>
  </header>
  <div class="w3-row-padding">
<!--<form action="index.php?controller=busqueda&method=validate" class="desplazar2 w3-margin"  method="POST">-->
<form action="/busqueda/validate" class="desplazar2 w3-margin"  method="POST">
...
<div  onclick="location.href='/busqueda/getOrbitales';" style="cursor:pointer;"class="w3-third">
...
<div  onclick="location.href='/busqueda/getSubOrbitales';" style="cursor:pointer;"class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px">
...
<div  onclick="location.href='/busqueda/getTours';" style="cursor:pointer;" class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px">
