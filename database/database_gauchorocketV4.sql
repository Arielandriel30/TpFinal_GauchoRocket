...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2022 a las 10:04:37
...
/*
Query suborbitales o tour
select sf.day,COUNT(1), sf.duration, rt.name
...
GROUP BY sf.day,sf.duration, rt.name
ORDER BY sf.sort_day asc
*/;

/*
Query entre destinos
select r.name, l.duration, s.name,  sft.short_name
FROM route r
